...
/*!
 * \brief 表示一块区域。维护着两个属性：数值范围（range）和区域大小（size）并且支持放缩（zoomIn()，zoomOut()）功能。
 *
 * 数值范围包括：
 *
 * \list
 ...
 * \endlist
 */
class SCHARTS_EXPORT AbstractDomain: public QObject
{
    Q_OBJECT
public:
