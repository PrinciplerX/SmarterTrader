...
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtTextEngine
{
public:
...
*/
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtPlainTextEngine: public QwtTextEngine
{
public:
    QwtPlainTextEngine();
...
*/
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtRichTextEngine: public QwtTextEngine
{
public:
    QwtRichTextEngine();
