...
TRADINGCURVEWIDGETSSHARED_EXPORT double qwtGetMin( const double *array, int size );
TRADINGCURVEWIDGETSSHARED_EXPORT double qwtGetMax( const double *array, int size );

TRADINGCURVEWIDGETSSHARED_EXPORT double qwtNormalizeRadians( double radians );
TRADINGCURVEWIDGETSSHARED_EXPORT double qwtNormalizeDegrees( double degrees );
