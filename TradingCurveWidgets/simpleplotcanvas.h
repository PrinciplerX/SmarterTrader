#ifndef SIMPLEPLOTCANVAS_H
#define SIMPLEPLOTCANVAS_H
...
/*!
  ...
  \sa QwtPlot::setgetCanvas(), QwtPlotGLCanvas
*/
class TRADINGCURVEWIDGETSSHARED_EXPORT SimplePlotCanvas : public QFrame
{
    Q_OBJECT
...
public:
    ...
    enum PaintAttribute
    {
        ...
        /*!
          ...
          SimplePlotCanvas supports the box model attributes for
    ...
    */
    ...
    explicit SimplePlotCanvas( AbstractPlot * = NULL );
    virtual ~SimplePlotCanvas();

    virtual AbstractPlot *plot();
    virtual const AbstractPlot *plot() const;
...
private:
    ...
    AbstractPlot* parentPlot;

    class PrivateData;
    PrivateData *d_data;
};

Q_DECLARE_OPERATORS_FOR_FLAGS( SimplePlotCanvas::PaintAttributes )

#endif // SIMPLEPLOTCANVAS_H
