...
*/
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtTransform
{
public:
    QwtTransform();
 ...
 */
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtNullTransform: public QwtTransform
{
public:
    QwtNullTransform();
 ...
 */
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtLogTransform: public QwtTransform
{   
public:
    QwtLogTransform();
 ...
 */
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtPowerTransform: public QwtTransform
{
public:
