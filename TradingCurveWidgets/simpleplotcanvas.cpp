...
static void qwtDrawBackground( QPainter *painter, SimplePlotCanvas *canvas )
{
    painter->save();
...
static void qwtFillBackground( QPainter *painter, SimplePlotCanvas *canvas )
{
...
class SimplePlotCanvas::PrivateData
{
public:
    PrivateData():
    ...
    double borderRadius;
    SimplePlotCanvas::PaintAttributes paintAttributes;
...
/*!
  ...
  \sa QwtPlot::setgetCanvas()
*/
SimplePlotCanvas::SimplePlotCanvas(AbstractPlot *plot ):
    QFrame( plot )
{
    parentPlot = plot;
    ...
    setPaintAttribute( SimplePlotCanvas::BackingStore, true );
    setPaintAttribute( SimplePlotCanvas::Opaque, true );
    setPaintAttribute( SimplePlotCanvas::HackStyledBackground, true );
}

//! Destructor
SimplePlotCanvas::~SimplePlotCanvas()
{
    delete d_data;
}

//! Return parent plot widget
AbstractPlot *SimplePlotCanvas::plot(){
    return parentPlot;
}

//! Return parent plot widget
const AbstractPlot *SimplePlotCanvas::plot() const {
    return parentPlot;
}

void SimplePlotCanvas::setPlot(AbstractPlot *plot) {
    parentPlot = plot;
}
...
*/
void SimplePlotCanvas::setPaintAttribute( PaintAttribute attribute, bool on )
{
...
*/
bool SimplePlotCanvas::testPaintAttribute( PaintAttribute attribute ) const
{
    return d_data->paintAttributes & attribute;
}

//! \return Backing store, might be null
const QPixmap *SimplePlotCanvas::backingStore() const
{
    return d_data->backingStore;
}

//! Invalidate the internal backing store
void SimplePlotCanvas::invalidateBackingStore()
{
...
*/
void SimplePlotCanvas::setFocusIndicator( FocusIndicator focusIndicator )
{
...
*/
SimplePlotCanvas::FocusIndicator SimplePlotCanvas::focusIndicator() const
{
...
/*!
  ...
  \sa borderRadius()
*/
void SimplePlotCanvas::setBorderRadius( double radius )
{
...
/*!
  ...
  \sa setBorderRadius()
*/
double SimplePlotCanvas::borderRadius() const
{
...
*/
bool SimplePlotCanvas::event( QEvent *event )
{
    if ( event->type() == QEvent::PolishRequest )
    {
        if ( testPaintAttribute( SimplePlotCanvas::Opaque ) )
        {
...
*/
void SimplePlotCanvas::paintEvent( QPaintEvent *event )
{
    QPainter painter( this );
    painter.setClipRegion( event->region() );

    if ( testPaintAttribute( SimplePlotCanvas::BackingStore ) &&
        d_data->backingStore != NULL )
    {
...
void SimplePlotCanvas::drawCanvas( QPainter *painter, bool withBackground )
{
...
/*!
  ...
  \sa setBorderRadius()
*/
void SimplePlotCanvas::drawBorder( QPainter *painter )
{
...
*/
void SimplePlotCanvas::resizeEvent( QResizeEvent *event )
{
...
/*!
  ...
  \param painter Painter
*/
void SimplePlotCanvas::drawFocusIndicator( QPainter *painter )
{
    const int margin = 1;
...
*/
void SimplePlotCanvas::replot()
{
    invalidateBackingStore();

    if ( testPaintAttribute( SimplePlotCanvas::ImmediatePaint ) )
...
void SimplePlotCanvas::updateStyleSheetInfo()
{
    if ( !testAttribute(Qt::WA_StyledBackground ) )
        return;
...
*/
QPainterPath SimplePlotCanvas::borderPath( const QRect &rect ) const
{
    if ( testAttribute(Qt::WA_StyledBackground ) )
    {
