...
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtColorMap
{
public:
    /*!
...
*/
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtLinearColorMap: public QwtColorMap
{
public:
    /*!
       Mode of color map
...
*/
class TRADINGCURVEWIDGETSSHARED_EXPORT QwtAlphaColorMap: public QwtColorMap
{
public:
